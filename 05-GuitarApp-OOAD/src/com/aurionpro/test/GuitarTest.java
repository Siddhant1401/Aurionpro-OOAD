...
public class GuitarTest {
	...
	public static void main(String[] args) {
		...
		i1.addGuitar("102", 600, new GuitarSpec(Builder.COLLINGS, "A1", Type.ELECTRIC, Wood.CEDAR, Wood.ALDER, 12));
		i1.addGuitar("102", 600, new GuitarSpec(Builder.COLLINGS, "A1", Type.ELECTRIC, Wood.CEDAR, Wood.ALDER, 12));
		...
		i1.addGuitar("105", 300, new GuitarSpec(Builder.COLLINGS, "A1", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 12));
